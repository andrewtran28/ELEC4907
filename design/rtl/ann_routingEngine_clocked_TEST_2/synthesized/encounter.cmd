...
#  Created on Tue Mar 10 01:56:40 2020                #
#                                                     #
#######################################################
...
getIoFlowFlag
setIoFlowFlag 0
floorPlan -site core -r 0.975279376905 0.699979 4 4 4 4
uiSetTool select
getIoFlowFlag
fit
...
addRing -stacked_via_top_layer AP -around core -jog_distance 0.1 -threshold 0.1 -stacked_via_bottom_layer M1 -layer {bottom M1 top M1 right M2 left M2} -width 2 -spacing 0.5 -offset 0.1
addRing -stacked_via_top_layer AP -around core -jog_distance 0.1 -threshold 0.1 -stacked_via_bottom_layer M1 -layer {bottom M1 top M1 right M2 left M2} -width 1 -spacing 0.16 -offset 0.1
