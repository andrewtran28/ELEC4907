...
#  Created on Tue Mar 10 01:43:25 2020                #
#                                                     #
#######################################################
...
set init_verilog synthesized/arbiter.v
...
create_constraint_mode -name constraint -sdc_files {synthesized/constraint.sdc}
...
getIoFlowFlag
setIoFlowFlag 0
floorPlan -site core -r 0.975279376905 0.699979 3 3 3 3
uiSetTool select
getIoFlowFlag
fit
