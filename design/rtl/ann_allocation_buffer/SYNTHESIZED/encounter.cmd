...
#  Created on Wed Mar 11 01:18:12 2020                #
#                                                     #
#######################################################
...
set init_verilog allocation_buffer.v
...
getIoFlowFlag
setIoFlowFlag 0
floorPlan -site core -r 0.915697674419 0.699982 2 2 2 2
uiSetTool select
getIoFlowFlag
fit
...
addRing -stacked_via_top_layer AP -around core -jog_distance 0.1 -threshold 0.1 -nets {VDD VSS} -stacked_via_bottom_layer M1 -layer {bottom M1 top M1 right M2 left M2} -width .9 -spacing 0.16 -offset 0.1
getIoFlowFlag
setIoFlowFlag 0
floorPlan -site core -r 0.830545622332 0.699965 3 3 3 3
uiSetTool select
getIoFlowFlag
fit
addRing -stacked_via_top_layer AP -around core -jog_distance 0.1 -threshold 0.1 -nets {VDD VSS} -stacked_via_bottom_layer M1 -layer {bottom M1 top M1 right M2 left M2} -width 1 -spacing 0.16 -offset 0.1
saveDesign allocation_buffer.enc
...
saveDesign allocation_buffer.enc
reportGateCount -level 5 -limit 100 -outfile allocation_buffer.gateCount
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -preCTS -idealClock -pathReports -drvReports -slackReports -numPaths 50 -prefix allocation_buffer_preCTS -outDir timingReports
