...
HD_PWD='C:/Users/vladimirmilicevic/Desktop/ANN/ANN/design/ANN/ANN/ANN.runs/routing_engine_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log routing_engine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source routing_engine.tcl
