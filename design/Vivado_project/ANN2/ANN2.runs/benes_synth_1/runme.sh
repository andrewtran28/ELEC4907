...
HD_PWD='C:/Users/vladimirmilicevic/Desktop/ANN/ANN/design/ANN/ANN/ANN.runs/benes_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log benes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source benes.tcl
