...
HD_PWD='C:/Users/vladimirmilicevic/Desktop/ANN2/ANN2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log layer_controller_dut.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source layer_controller_dut.tcl
