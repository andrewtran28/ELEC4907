...
HD_PWD='C:/Users/vladimirmilicevic/Desktop/ANN2/ANN2.runs/l1_cache_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log l1_cache.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source l1_cache.tcl
